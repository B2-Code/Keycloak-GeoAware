...
public class GeoInfoMapperTest extends BaseMapperTest {
    ...
    @Test
    void testCreateGeoInfoProtocolMapper() {
        Map<String, String> config = new HashMap<>();
        config.put("claim.name", "geoip");

        ProtocolMapperRepresentation rep = makeMapper("Geo-Info-Mapper", GeoIpInfoMapper.PROVIDER_ID, config);
    ...
    void testIfClaimIsInIdToken() {
        ...
        Object geoIpClaim = token.getOtherClaims().get("geoip");
    ...
    void testIfClaimIsInUserInfo() {
        ...
        Object geoIpClaim = userInfo.getOtherClaims().get("geoip");
        Assertions.assertNotNull(geoIpClaim);
    }
}
